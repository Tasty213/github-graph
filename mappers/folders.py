...
def process_folder(
    folder: Union[github.ContentFile.ContentFile, str],
    base: Database,
    ...
    if deleted:
        ...
        logger.info(f"Processing folder {properties['name']}")
        base.create_node_generic(["Folder"], properties)

        base.create_relationship(parent_key, properties["key"], "CHILD")
...
def _process_deleted_folder(
    ...
    base.create_relationship(parent_key, folder_properties["key"], "CHILD", {})
